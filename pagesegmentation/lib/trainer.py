...
class TrainSettings(NamedTuple):
    ...
    loss: str = "categorical_crossentropy"  # jacard_coef_loss, dice_coef_loss, categorical_hinge, dice_and_categorical
    monitor: str = 'val_loss'  # val_accuracy, accuracy, loss
